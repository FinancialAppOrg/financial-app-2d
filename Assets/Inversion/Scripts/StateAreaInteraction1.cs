...
public class StateAreaInteraction : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        ...
        /*
        Vector3 targetPosition = new Vector3(transform.position.x, transform.position.y, transform.position.z);  // Posición del objetivo (StateArea)
